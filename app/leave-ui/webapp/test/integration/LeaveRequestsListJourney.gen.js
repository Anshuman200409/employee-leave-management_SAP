...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("LeaveRequestsListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheLeaveRequestsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheLeaveRequestsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheLeaveRequestsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheLeaveRequestsListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheLeaveRequestsListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheLeaveRequestsListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheLeaveRequestsListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheLeaveRequestsObjectPageGenerated.iSeeThisPage();
        });
